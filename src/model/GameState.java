...
public class GameState {
    private final DoubleProperty wallet = new SimpleDoubleProperty(500.0); // Budget initial [cite: 41]
    private final StringProperty selectedSeed = new SimpleStringProperty("Blé");

    // Stocks observables (Graines, Nourriture, Produits)
    ...
    public Crop[] plots = new Crop[64]; // Grille 8x8
